...
def registro_cuenta():
    ...
    with dpg.window(tag="register_window", label="Registro de cuenta", no_close=True, no_collapse=True, no_resize=True, width=281, height=250, pos=(620,300)):
      dpg.add_text("Cedúla")
      dpg.add_input_text(tag="cedula", hint="Cedúla", width=265)
      ...
      dpg.add_button(label="Registrar Cuenta", track_offset=0.5, callback=lambda: (dpg.delete_item("register_window"), dpg.configure_item("login_window", show=True)))
